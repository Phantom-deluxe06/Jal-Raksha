...
DATA_ASSETS = [
    ...
    "data/dem/rishiganga_chamoli_srtm30m.tif",
    "data/dem/mullaperiyar_periyar_srtm30m.tif",
    "data/dem/tehri_bhagirathi_srtm30m.tif",
    "backend/outputs/swe_rishiganga_chamoli2021/metadata.json",
